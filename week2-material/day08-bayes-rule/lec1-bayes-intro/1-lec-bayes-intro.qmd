...
Consider the well-known coin-tossing example. What is the probability of obtaining heads in a single toss?

. . . 

There are only two possible outcomes: heads and tails. By symmetry, if the coin is fair, the two outcomes are equally likely. Therefore, the probability of obtaining heads is 1/2.
