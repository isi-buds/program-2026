...
```{r}
# here is some structural starter code 
# mean is the user specified mean parameter 
# var is the user specified variance parameter
# num_draws is the user specified number of draws 
...
# Looking at different sample sizes and plotting, should be rougly bell shaped for 
# normal distribution
npar(mfrow=c(1,2))
hist(my_norm_sample)
