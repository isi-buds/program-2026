...
- Download cases/tests/deaths data from [CA Open Data Portal](https://data.ca.gov/dataset/covid-19-time-series-metrics-by-county-and-state-archived/resource/246e823b-4ce9-4258-a3cd-88aecd8744de). Or load them from the local repo:
...
- Join the two data sets by date and county
...
- Download a file with county population sizes from our repo
